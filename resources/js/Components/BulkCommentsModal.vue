    ...
    <div v-if="show" class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ol class="list-decimal list-inside space-y-1">
                                    <li>Descarga la plantilla con los folios de evaluaciones Likert</li>
                                    <li>Edita el archivo Excel agregando comentarios (una fila por comentario)</li>
                                    <li>Cada fila debe tener: Folio (1, 2, 3...), Comentario (o Comentarios), y Factor (o Factores)</li>
                                    <li>Sube el archivo modificado usando el botón de abajo</li>
                                </ol>
                                <p class="mt-2 text-xs">
                                    <strong>Nota:</strong> Puedes escribir el folio como 1, 2, 60, 100. El sistema lo convertirá a 0001, 0002, 0060, 0100 automáticamente. Las columnas pueden ser singular o plural (Comentario/Comentarios, Factor/Factores).
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-6">
                    ...
                    >
                        ...
                        {{ downloading ? 'Descargando...' : 'Descargar Plantilla de Comentarios' }}
                    </button>
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Paso 2: Subir Archivo con Comentarios
                    </label>
            ...
            <div class="flex justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
                ...
                >
                    <span v-if="!uploading">Cargar Comentarios</span>
...
const downloadTemplate = () => {
    ...
    window.location.href = route('organization.results.comments-template', { organization: props.organizationId })
    setTimeout(() => {
...
const uploadFile = () => {
    ...
    router.post(
        route('organization.results.bulk-comments', { organization: props.organizationId }),
