    ...
    <div v-if="show" class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ol class="list-decimal list-inside space-y-1">
                                    <li>Descarga la plantilla {{ hasData ? 'con los datos actuales' : 'vacía' }}</li>
                                    <li>Edita el archivo Excel con los datos {{ hasData ? 'a actualizar/agregar' : 'a cargar' }}</li>
                                    <li>Sube el archivo modificado usando el área de abajo</li>
                                </ol>
                                <p class="mt-2 text-xs">
                                    <strong>Nota:</strong> {{ hasData ? 'Si el dato existe, se actualizará. Si no existe, se agregará.' : 'Los datos del archivo se agregarán a la base de datos.' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Paso 2: Subir Archivo {{ hasData ? 'Modificado' : 'con Datos' }}
                    </label>
            ...
            <div class="flex justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
                ...
                >
                    <span v-if="!uploading">{{ uploadButtonText }}</span>
...
const props = defineProps({
    ...
    title: {
        type: String,
        default: 'Importar Datos desde Excel'
    },
    downloadRoute: {
        type: String,
        required: true
...
const downloadTemplate = () => {
    ...
    window.location.href = props.downloadRoute
    setTimeout(() => {
