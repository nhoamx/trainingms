<template>
  <div class="space-y-8">
    ...
    <!-- Coming Soon for other organizations -->
    <div v-else class="grid md:grid-cols-1 gap-6 max-w-xl mx-auto">
      <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 border border-gray-200 text-center">
        <div class="text-5xl mb-4">🚧</div>
        <h3 class="text-2xl font-bold text-gray-900 mb-2">
          {{ locale === 'es' ? 'Documento en Preparación' : 'Document in Preparation' }}
        </h3>
        <p class="text-gray-600 text-sm">
          {{ locale === 'es' 
            ? 'Estamos trabajando en la elaboración del reporte para su organización. Pronto estará disponible para su descarga.' 
            : 'We are working on preparing the report for your organization. It will be available for download soon.' 
          }}
        </p>
      </div>
    </div>
