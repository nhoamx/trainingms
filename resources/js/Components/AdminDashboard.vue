    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="org in organizations" :key="org.id"
        ...
        <div class="bg-gray-50 px-5 py-3">
          <a 
            :href="route('organization.report', { id: org.id })"
            class="w-full flex items-center justify-center text-blue-600 hover:text-blue-800 font-medium py-2 transition-colors"
          >
