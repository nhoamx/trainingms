      ...
      <div v-for="org in organizations" :key="org.id"
        ...
        <div class="bg-gray-50 px-5 py-3">
          ...
          <div class="grid grid-cols-2 gap-2">
            ...
            <!-- Botón: NOM-002 -->
            <a :href="route('organizations.assets.index', { organization: org.id })"
              class="flex items-center justify-center text-red-700 hover:text-red-900 font-medium py-2.5 px-3 transition-colors bg-red-50 border border-red-300 rounded-md hover:bg-red-100 hover:shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <span class="text-sm">NOM-002</span>
            </a>
