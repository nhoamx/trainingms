        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <Link :href="route('organization.online-results', { id: organization.id })"
                ...
                <!-- INE Images Section -->
                <div v-if="ine_images.ine_frente || ine_images.ine_reverso"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div v-if="ine_images.ine_frente" class="space-y-2">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <img v-if="ine_images.ine_frente.exists" :src="ine_images.ine_frente.url"
                                    alt="INE Frente"
                        ...
                        <div v-if="ine_images.ine_reverso" class="space-y-2">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <img v-if="ine_images.ine_reverso.exists" :src="ine_images.ine_reverso.url"
                                    alt="INE Reverso"
                                    class="max-w-full h-auto rounded cursor-pointer hover:opacity-90 transition-opacity"
...
const getTraumaticQuestionText = (questionKey) => {
    // Extraer el índice de la pregunta (ej: "acontecimientos_traumaticos_0" -> 0)
    const match = questionKey.match(/acontecimientos_traumaticos_(\d+)/);
    if (match && props.traumatic_questions) {
