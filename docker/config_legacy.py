...
likert_genero = {
    'masculino': (1556, 886, 35, 35),
    'femenino': (1554, 947, 35, 35),
}

likert_turno = {
    'matutino': (2232, 886, 35, 35),
    'nocturno': (2232, 950, 35, 35),
}

likert_tipo_contrato = {
    'sindicalizado': (1553, 1067, 35, 35),
    'confianza': (1554, 1127, 35, 35),
}

# Likert Puestos (lista vertical de 24 items)
# Nota: Solo se tomó la primera posición. Itera hacia abajo en tu pipeline para capturar los 24 items.
likert_puestos = {
    'first': (954, 1246, 35, 35),
}

# Likert Áreas (lista vertical de 17 items)
# Nota: Solo se tomó la primera posición. Itera hacia abajo en tu pipeline para capturar los 17 items.
likert_areas = {
    'first': (1633, 1241, 35, 35),
}
